...
Else
            ...
            For Each pedido As EntidadesDTO.PedidoDTO In pedidos.Values
                ...
                Response.Write("<td>" + "<a href='/Account/Pedidos.aspx?action=delete&id=" + pedido.id.ToString() + "'>Borrar</a> " + "<a href='/Account/Pedidos.aspx?action=put&id=" + pedido.id.ToString() + "'>Modificar</a> " + "<a href='/Account/Pedidos.aspx?action=details&id=" + pedido.id.ToString() + "'>Detalle</a> " + "</td>")
                Response.Write("</tr>")
            Next
            Response.Write("</table>")
        End If
